...
AmesHousingFull <- read.csv("~/Downloads/ameshouse/AmesHousing.csv")
...
ggplot(data = AmesHousing, mapping = aes(x = SalePrice)) + geom_histogram()
```
...
ggplot(data = AmesHousing, mapping = aes(x = GrLivArea, y = SalePrice))
```
...
ggplot(data = AmesHousing, mapping = aes(x = GrLivArea, y = SalePrice, color = KitchenQuality)) +
  geom_point()
```
...
ggplot(data = AmesHousing) +
  geom_point( mapping = aes(x = GrLivArea, y = SalePrice, color = KitchenQuality)) +
  geom_smooth(mapping = aes(x = GrLivArea, y = SalePrice, color = KitchenQuality))
```
...
ggplot(mapping = aes(x = GrLivArea, y = SalePrice)) +
  geom_point(data = subset(AmesHousing, KitchenQuality == "Excellent"), color = "red") +
  geom_point(data = subset(AmesHousing, KitchenQuality == "Average"),   color = "blue")
```
...
ggplot(data = AmesHousing, mapping = aes(x = GrLivArea, y = SalePrice, color = KitchenQuality)) +
  geom_point() +
  theme_bw() +
  labs(x = "Above Ground Living Area", y = "Sales Price", color = "Kitchen Quality")
```
